def Train_LowpassCNN_lbld(dataset, io_dir, train_params, num_levels, device='0'):
    ...
    short_dir = io_dir + 'pyramids/short_lbld/gpyr/g' + str(num_levels) + '/'   
    long_dir = io_dir + 'pyramids/long_lbld/lpyr/g' + str(num_levels) + '/'     
    save_dir = io_dir + 'checkpoints/lp_sub/only_lbld/'
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        if epoch%save_freq==0:
            torch.save(model, os.path.join(save_dir, 'modellp_pt.pth'))